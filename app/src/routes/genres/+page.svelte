...
<svelte:head>
  ...
  <meta name="description" content="Explore music by genre - find tracks, albums, and artists in your favorite genres" />
</svelte:head>

<div class="container max-w-5xl mx-auto py-8 px-4">
  <h1 class="text-3xl font-bold mb-6">Browse by Genre</h1>
  ...
  <Tabs value={currentTab} onValueChange={(value) => currentTab = value} class="mb-8">
    ...
    <TabsContent value="popular" class="mt-0">
      <h2 class="text-2xl font-semibold mb-4">Popular Genres</h2>
      <p class="text-muted-foreground mb-6">Trending genres this month based on listening activity</p>
    ...
    <TabsContent value="all" class="mt-0">
      <h2 class="text-2xl font-semibold mb-4">All Genres</h2>

		...
		<Card class="col-span-2 lg:col-span-1">
			...
			<CardContent class="space-y-4">
				<div class="bg-primary/10 rounded-lg p-6 text-center">
					...
					<h3 class="mb-2 text-xl font-semibold">NFT Creation & Management</h3>
	...
	<Card>
		...
		<CardContent class="space-y-4">
			<div class="space-y-2">
				...
				<p class="text-muted-foreground text-sm">
					Music NFTs are unique digital assets that represent ownership of a piece of music. They
					allow artists to tokenize their work and fans to collect and own pieces of music history.
				</p>
			</div>
			...
			<div class="space-y-2">
				...
				<p class="text-muted-foreground text-sm">
					Our NFT platform will support creator royalties, allowing you to earn a percentage of all
					secondary sales of your NFTs. This creates a new revenue stream that continues as your
					music gains value in the collector market.
				</p>
			</div>
			...
			<div class="space-y-2">
				...
				<p class="text-muted-foreground text-sm">
					Yes, creating NFTs for your music does not transfer copyright or ownership of the original
					work. You'll maintain all your rights to the music while offering unique collectible
					versions to your fans.
				</p>
			</div>
			...
			<div class="space-y-2">
				...
				<p class="text-muted-foreground text-sm">
					We'll be using the Sui blockchain for all NFT operations, the same network that powers our
					tipping and payment features. This ensures a seamless experience and lower transaction
					costs.
				</p>
			</div>
			...
			<div class="space-y-2">
				...
				<p class="text-muted-foreground text-sm">
					We're currently in development and aim to launch NFT features in the coming months. Sign
					up to be notified when they become available, and you'll be among the first to access
					these new tools.
				</p>
			</div>
		</CardContent>

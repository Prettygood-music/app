...
<div class="space-y-6">
  <div class="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
    ...
    <div class="flex flex-col sm:flex-row gap-2">
      <Button variant="default" href="/dashboard/artist/uploads/new">
  ...
  <Tabs value="tracks" class="space-y-4">
    ...
    <TabsContent value="uploads" class="space-y-4">
        ...
        <CardContent>
          <div class="grid gap-6 md:grid-cols-2">
            <Card>
              ...
              <CardFooter>
                <Button class="w-full" on:click={() => goto('/artist-dashboard/uploads/new')}>Upload Track</Button>
              </CardFooter>
            </Card>
      ...
      <Card>
        ...
        <CardFooter>
          <Button class="w-full" on:click={() => goto('/artist-dashboard/uploads/new')}>Start Upload</Button>
        </CardFooter>
      </Card>
    </TabsContent>
  </Tabs>

...
<div class="space-y-6">
  ...
  <!-- Overview Cards -->
  <EarningsOverview timeFrame={timeFrame} />
        ...
        <CardContent>
          <div class="grid md:grid-cols-2 gap-4">
            ...
            <div class="space-y-4">
              ...
              <p class="text-sm text-muted-foreground text-center my-8">
                Earnings distribution data will be displayed here showing your top earning tracks and their relative contribution to your revenue.
              </p>
            </div>
          </div>
        </CardContent>
